...
REPO_URL = 'https://github.com/kamanazan/superlists.git'
...
def deploy():
    ...
    _update_database(source_folder) #should we use it? since we are using pgsql
...
def _update_database(source_folder):
    # how to automaticaly configure postgresql?
    pass
